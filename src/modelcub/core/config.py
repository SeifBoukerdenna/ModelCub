...
class Config:
    ...
    def to_yaml_string(self) -> str:
        ...
        lines.append("#   SDK:    project.set_config('key', value)")
        lines.append("#   UI:     Use the web interface settings page")
        lines.append("#")
        lines.append("# Example: modelcub project config set defaults.batch_size 32")
        lines.append("")
